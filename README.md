# Playwright QA Tech Lead Test Boilerplate

Welcome to the Playwright QA Tech Lead Test Boilerplate! This repository contains a boilerplate code setup specifically designed for candidates applying for a Software Development Engineer in Test (SDET) position. It provides a solid foundation to get you started with writing and running automated tests using Playwright.

## Scripts

### `yarn install`

Installs all the dependencies required for the project. you may need to run yarn playwright install if you still run into issues with playwright.
